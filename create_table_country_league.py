...
# querystring = {"name":'Premier League',"country":'England'}

# headers = {
#     "X-RapidAPI-Key": "c2ddd697b2mshc3920ab2771b3d5p103ccdjsn510fcbbc741d",
...
# data= response.json()
# print(data)
# league_api_id = data['response'][0]['league']['id']
# print(league_api_id)

# for country, league in country_list:
...
#         else:
#             print('A API retornou uma resposta vazia para a solicitação.')
#     else:
...
#     query = 'INSERT INTO league (name, api_id, country_id) VALUES (%s, %s, %s)'
#     values = (league, league_api_id,country_id)
#     cursor.execute(query, values)
a=1