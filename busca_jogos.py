...
list_pais_id = [['Belgium','Pro League', 144],['Greece','Greek Super League', 197],['Scotland','SPL', 179], ['Scotland','Scottish Championship', 180], ['Italy', 'Serie A', 135], ['Italy', 'Serie B', 136],
                ...
                ['Denmark', 'Superliga', 119], ['USA', 'Major League Soccer', 253], ['Norway', 'Eliteserien', 103], ['Australia', 'A-League', 188],['China','Super League', 169],['Belgium','First Division B', 145],['Austria', 'Bundesliga', 218],
                ['Sweden', 'Allsvenskan', 113], ['Switzerland', 'Super League', 207],  ['Mexico', 'Liga MX', 262], ['Poland', 'Ekstraklasa', 106],['Finland', 'Veikkausliiga', 244], ['Japan', 'J1 League', 98],['Argentina','Primera Division', 128]]
